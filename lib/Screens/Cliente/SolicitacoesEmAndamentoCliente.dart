...
void main() {
  runApp(MaterialApp(
    home: SolicitacoesEmAndamentoCliente(),
  ));
}

class SolicitacoesEmAndamentoCliente extends StatefulWidget {
  @override
  _SolicitacoesEmAndamentoClienteState createState() => _SolicitacoesEmAndamentoClienteState();
}

class _SolicitacoesEmAndamentoClienteState extends State<SolicitacoesEmAndamentoCliente> {
  //LISTA PARA TESTE
      ...
      drawer: Drawer(
        child: ListView(
          ...
          children: <Widget>[
            ...
            ListTile(
              leading: Icon(Icons.hourglass_full,color: Colors.yellow,),
              title: Text('Solicitações em andamento',style:TextStyle(color: Colors.blue),),
            ),
            ListTile(
