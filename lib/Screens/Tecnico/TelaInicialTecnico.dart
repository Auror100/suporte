...
void main() {
  runApp(MaterialApp(
    home: TelaInicialTecnico(),
  ));
}

class TelaInicialTecnico extends StatefulWidget {
  @override
  _TelaInicialTecnicoState createState() => _TelaInicialTecnicoState();
}

class _TelaInicialTecnicoState extends State<TelaInicialTecnico> {
  //LISTA PARA TESTE
