...
class HistoricoAdmin extends StatefulWidget {
  @override
  _HistoricoAdminState createState() => _HistoricoAdminState();
}

class _HistoricoAdminState extends State<HistoricoAdmin> {
  //LISTA PARA TESTE
